...
const nextConfig = {
  ...
  async headers() {
    const contentSecurityPolicy = [
      ...
      "form-action 'self'",
      `script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net${process.env.NODE_ENV !== 'production' ? " 'unsafe-eval'" : ''}`,

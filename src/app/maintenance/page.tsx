...
export default function Page() {
  const schema = { '@context': 'https://schema.org', '@type': 'WebPage', name: 'Scheduled Maintenance', url: `${siteConfig.url}/maintenance`, description: 'The Bionics Enviro Tech website is undergoing scheduled maintenance.' }

...
export default function Offices() {
  return (
    <section className="relative overflow-hidden bg-[#071b12] text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-7 md:px-8 md:py-10 lg:px-10 lg:py-12">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-2 text-2xl font-black tracking-tight md:mt-3 md:text-4xl">
            Visit us in Tamil Nadu
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-300 md:mt-3 md:text-base md:leading-7">
            Connect with our team at our head office in Erode or corporate
            office in Chennai.
          </p>
        </div>
        ...
        <div className="mt-5 grid gap-3 md:mt-7 md:grid-cols-2 md:gap-4">
          {offices.map((office, index) => {
            return (
              <article
                key={office.id}
                className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/[.055] p-4 transition duration-300 hover:-translate-y-1 hover:border-emerald-400/35 hover:bg-white/[.075] md:rounded-2xl md:p-6"
              >
                <span
                  aria-hidden="true"
                ...
                <div className="relative flex items-start gap-3 md:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-0.5 text-xl font-bold md:mt-1 md:text-2xl">
                      {office.city}
                    </h3>
                  </div>
                </div>

                <div className="relative mt-3 flex items-start gap-2.5 border-t border-white/10 pt-3 md:mt-5 md:gap-3 md:pt-4">
                  <MapPin

...
export default function OverviewSection({ title, paragraphs, imageSrc, imageAlt }: OverviewSectionProps) {
    return (
        <section className="mx-auto max-w-7xl px-4 py-5 sm:px-8 lg:px-10 lg:py-8">
            <div className="grid gap-5 rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm sm:rounded-[2rem] sm:p-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-7 lg:p-8">

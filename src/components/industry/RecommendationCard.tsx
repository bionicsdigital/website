...
export default function RecommendationCard({
    ...
    return (
        <section className="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:px-10 lg:py-14">
            <div className="rounded-[2rem] border border-slate-200 bg-gradient-to-br from-emerald-950 via-emerald-900 to-green-800 p-6 text-white shadow-2xl sm:p-8 lg:p-10">

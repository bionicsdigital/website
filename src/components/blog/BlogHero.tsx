  ...
  return (
    <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-emerald-900 text-white">
      <div className="mx-auto max-w-7xl px-5 pb-12 pt-28 sm:px-8 lg:px-10 lg:pb-14 lg:pt-32">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-blue-50/90 sm:text-lg sm:leading-8">
          Practical technical guidance on bioculture, ETP and STP operation,
          compliance and sustainable plant performance.
        </p>
        <Link
          href="#articles"
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-blue-900 hover:bg-cyan-50"
        >

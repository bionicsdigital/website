...
export default function ProductBenefits({ title, description, benefits }: ProductBenefitsProps) {
    return (
        <section className="mx-auto max-w-7xl px-4 py-10 sm:px-8 lg:px-10 lg:py-20">
            ...
            <div className="mt-7 grid gap-4 md:grid-cols-2 lg:mt-10 lg:gap-6 xl:grid-cols-4">
                {benefits.map((benefit) => {
                    const Icon = benefit.icon

                    return (
                        <div key={benefit.title} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-xl sm:p-6">
